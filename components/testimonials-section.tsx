  ...
  return (
    <section className="py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="block relative bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 lg:p-16 backdrop-blur-sm">
        ...
        <div className="text-center mt-12 md:mt-16">
          ...
          >
            Blimp empowers teams to automate without barriers — where productivity meets simplicity.
          </p>
        </div>
      </div>
    </section>
